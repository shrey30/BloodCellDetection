...
# === Set Paths to Your Dataset (make paths absolute based on script location) ===
...
# save model to the script directory (avoid depending on current working dir)
out_model = os.path.join(script_dir, "Blood2.keras")
