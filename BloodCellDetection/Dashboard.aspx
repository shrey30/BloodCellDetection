...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="upload-box">
        ...
        <p>Microscopic Image (JPG or PNG format only)</p>
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <div class="upload-box">
         ...
         <div class="upload-box">
             <asp:Button ID="Button3" runat="server" Text="View Report" Height="32px" PostBackUrl="~/GenerateReport.aspx" Width="124px" />
         </div>
    </asp:Panel>
</asp:Content>
